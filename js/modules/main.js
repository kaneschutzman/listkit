...
var app = {
    ...
    populate: function(URL, lifestyle) {
        ...
        this.searchlist.push(new app.searchlist({
            URL: URL,
            lifestyle: lifestyle
        }))
    }.bind(this),
    ...
    populate2: function(URL, lifestyle) {
        ...
        this.latestlist.push(new app.latestlist({
            URL: URL,
            lifestyle: lifestyle
        }))
    }.bind(this),
    ...
    populate3: function(URL, lifestyle) {
        ...
        this.forkedlist.push(new app.forkedlist({
            URL: URL,
            lifestyle: lifestyle
        }))
    }.bind(this),
    ...
    savelist: function() {
        return m.request({
            ...
            method: 'POST',
            url: 'http://localhost:3000/api/v1/lists/list',
            data: {
                nickname: app.nickname,
                lifestyle: app.lifestyle,
                list: this.list,
                forked_id: app.getURL()
            },
    ...
    modlist: function() {
        return m.request({
            ...
            method: 'POST',
            url: 'http://localhost:3000/api/v1/lists/edit',
            data: {
                nickname: app.nickname,
                lifestyle: app.lifestyle,
                list: this.list,
    ...
    searchApi: function() {
        ...
        if (app.search() != '') {
            return m.request({
                ...
                method: 'POST',
                url: 'http://localhost:3000/api/v1/lists/search',
                data: {
                    lifestyle: app.search
                },
                unwrapError: function(response) {
                    return response['err']
                }
    ...
    latestfive: function() {
        ...
        return m.request({
            ...
            method: 'GET',
            url: 'http://localhost:3000/api/v1/lists/latestfive',
            data: {},
            unwrapError: function(response) {
                return response['err']
            }
    ...
    mostforked: function() {
        ...
        return m.request({
            ...
            method: 'GET',
            url: 'http://localhost:3000/api/v1/lists/mostforked',
            data: {},
            unwrapError: function(response) {
                return response['err']
            }
